...
from ODM_lib.BoundingBox import BoundingBox
from ODM_lib.BoundingBoxes import BoundingBoxes
from ODM_lib.Evaluator import *
from ODM_lib.utils import BBFormat
...
parser.add_argument('-gt',
                    '--gtfolder',
                    dest='gtFolder',
                    default=os.path.join(currentPath, 'GT'),
                    metavar='',
                    help='folder containing your ground truth bounding boxes')
parser.add_argument('-det',
                    '--detfolder',
                    dest='detFolder',
                    default=os.path.join(currentPath, 'DR'),
                    metavar='',
