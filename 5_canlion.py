...
for txt_file in ground_truth_files_list:
    ...
    for line in lines_list:
        ...
        record = [int(left), int(top), int(right)-int(left), int(bottom)-int(top), convert_labels(class_name)]
    ...
    for line in dr_lines_list:
        ...
        record = [int(left), int(top), int(right)-int(left), int(bottom)-int(top), float(conf), convert_labels(class_name)]
